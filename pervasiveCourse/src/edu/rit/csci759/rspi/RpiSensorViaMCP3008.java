...
public class RpiSensorViaMCP3008 {
	...
	public static void main(String[] args)
	{
        ...
        final GpioPinDigitalOutput pin1 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_27, "MyLED", PinState.HIGH);
        final GpioPinDigitalOutput pin2 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_28, "MyLED", PinState.LOW);
        final GpioPinDigitalOutput pin3 = gpio.provisionDigitalOutputPin(RaspiPin.GPIO_29, "MyLED", PinState.LOW);
			...
			// 10 mv per degree
	        temp_C = (float) (((tmp36_mVolts - 100.0) / 10.0) - 40.0);
